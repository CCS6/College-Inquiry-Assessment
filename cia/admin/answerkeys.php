                        ...
                        foreach($result as $key){
                            ...
                            <tr class="gradeX">
                                ...
                                <td class="actions">
                                    ...
                                    <a href="#" data-rel="<?=$key['anskeyID']?>" class="on-default edit-row"><i class="fa fa-pencil"></i></a>
                                    <a href="#" data-rel="<?=$key['anskeyID']?>" class="on-default remove-row"><i class="fa fa-trash-o"></i></a>
                                </td>
                            </tr>
                            <?php
                        }
